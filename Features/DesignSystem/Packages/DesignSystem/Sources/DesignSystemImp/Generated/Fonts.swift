...
public enum FontFamily {
  ...
  public enum SFProText {
    public static let bold = FontConvertible(name: "SFProText-Bold", family: "SF Pro Text", path: "SFProText-Bold.ttf")
    public static let medium = FontConvertible(name: "SFProText-Medium", family: "SF Pro Text", path: "SFProText-Medium.ttf")
    public static let regular = FontConvertible(name: "SFProText-Regular", family: "SF Pro Text", path: "SFProText-Regular.ttf")
    public static let semibold = FontConvertible(name: "SFProText-Semibold", family: "SF Pro Text", path: "SFProText-Semibold.ttf")
    public static let all: [FontConvertible] = [bold, medium, regular, semibold]
  }
  public static let allCustomFonts: [FontConvertible] = [Inter.all, SFProText.all].flatMap { $0 }
